...
a.endsWith(".")||(a+="."),a=n?`An error occurred during authorization: ${a} Contact the site administrator for more information.`:`An error occurred during authorization: ${a} [Contact Dynamsoft](https://www.dynamsoft.com/company/contact/) for more information.`;else a=n?"Failed to connect to the Dynamsoft License Server: network connection error. Check your Internet connection or contact the site administrator for more information.":"Failed to connect to the Dynamsoft License Server: network connection error. Check your Internet connection or [contact Dynamsoft](https://www.dynamsoft.com/company/contact/) for more information.";
a=Error(a);v&&v.errorCode&&(a.ltsErrorCode=v.errorCode);throw a;}})();r=yield l.text();try{F||L||(H.setItem(K,yield Fa(JSON.stringify([p,b]))),F=b),H.setItem(fa,r)}catch(Ga){}fetch(J[0]+"verify",{mode:"cors",method:"POST",headers:{"Content-Type":"application/json","lts-time":"options"},body:"[]",timeout:3E4});return r}))(),new e((a,b)=>{let e;e=n?"Failed to connect to the Dynamsoft License Server: network timed out. Check your Internet connection or contact the site administrator for more information.":
...
E;}))());yield va}),Ta=()=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){let a=(new Date).kUtilFormat("yyyy-MM-ddTHH:mm:ss.SSSZ"),b=yield R();Y(b);if(b&&b<a){if(E)throw Error("Failed to connect to the Dynamsoft License Server. The cached license has expired. Please get connected to the network as soon as possible or contact the site administrator for more information.");throw Error("Your system date and time appear to have been changed, causing the license to fail. Please correct the system data and time and try again.");
